...
class App extends React.Component {
  ...
  handleGetLocation(e) {
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(this.getPosition, this.errorMessage, this.positionOptions);
    } else {
    ...
    return (
      <Container fluid>
        <Row>
          ...
          <Col xs={4}>
            <Button variant='primary' onClick={this.handleGetLocation}>Get Location</Button>
          </Col>
          <Col xs={4}>
